  ...
  <div class='board'>
    ...
    <div class="board-right">
      ...
      <div class="inpt-div">
        ...
        <input v-model="Account" type="text" placeholder="请输入账号" style="margin-left: 32px; font-size: 18px; conor: #ccc; border: none; outline: medium;">
      ...
      <div class="inpt-div" style="margin-top: 37px;">
        ...
        <input v-model="Password" type="password" placeholder="请输入密码" style="margin-left: 32px; font-size: 18px; conor: #ccc; border: none; outline: medium;">
        <hr style="width: 446px; height: 1px; background-color: #ccc;">
      </div>
